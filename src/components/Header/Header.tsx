...
const Header = () => {
  ...
  return (
    <header className="w-100 product-header position-fixed">
      <div
        className="header-wrapper d-flex justify-content-between pe-3 position-relative"
        style={theme === "dark" ? { backgroundColor: "#c2c2c2" } : {}}
      >
        <div className="left-header-content d-flex flex-row align-items-center">
          <button className="xem-header-nav-btn d-flex justify-content-center align-items-center me-3">
            <img src={NavIconMenu} alt="nav" />
          </button>
        ...
        <div className="right-header-content d-flex flex-row align-items-center">
          <Tooltip title="Change Theme">
            <button
              className="squircle-btn theme-change-btn me-2"
              onClick={toggleTheme}
            >
